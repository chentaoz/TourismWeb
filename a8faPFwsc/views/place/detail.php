...
<!--                            <div class="desti_wdp col-md-12" style="margin-top: 0px"><a href="#comment"><img src="--><?//= base_url('images/w_dp.png') ?><!--"></a></div>-->
							<a href="#myModal_edit_attr" role="button" class="btn btn-primary" data-toggle="modal" style=" background: #88c74f;    border: 1px #88c74f solid">编辑属性</a>
							<a href="#myModal_add_sp" role="button" class="btn btn-primary" data-toggle="modal" style=" background: #88c74f;    border: 1px #88c74f solid">为此目的地增加一种运动方式</a>
                        </div>
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-body">		                                         
										  <div class="dropdown">
											<button class="btn btn-success dropdown-toggle" type="button" data-toggle="dropdown"><strong id="setfont">新增活动</strong>
									...
									<div class="modal-footer">
										<button type="button" class="btn btn-success"  id="add_sport">确定</button>
									</div>
								</div>
							</div>
						</div>
...
//评分js jamse add
 ...
 //平均分的js
	...
	alert($(this).attr("favalue"));
	 var url="<?=WWW_domian?>"+'place/userAddSport/'+$(this).attr("favalue");
	 ...
	 success:function(response){
		 ...
		 if(response=false){
			 ...
			 for( var i=0;i<response.length;i++){
				 console.log(response[i]['attribute']);
			 }
		 }
	 }
