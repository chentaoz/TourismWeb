...
//                                <caption style='visibility: hidden'>详细信息</caption>
						...
						<a href="#myModal_edit_attr" role="button" class="btn btn-primary pull-right" data-toggle="modal" style=" background: #88c74f;    border: 1px #88c74f solid">编辑属性</a>
							<a href="#myModal_add_sp" role="button" class="btn btn-primary pull-right" data-toggle="modal" style=" background: #88c74f;    border: 1px #88c74f solid">为此目的地增加一种运动方式</a>
	 ...
	 success:function(response){
		 ...
		 if(response==false){
			 ...
			 for( var i=0;i<response.length;i++){
				 str_element+="<center>"+response[i]['attribute']+"</center>"+"<input style='width:100%' type='text' name='"+strname+"_"+response[i]['attribute']+"'> <br/>";
			 }
