                ...
                <div class="mod card" style="padding-top:10px;">
                    <form id="form1" method="post" action="">
                        <div class="form-group">
                            <input id="title" name="title" type="text" class="form-control" placeholder="标题" aria-describedby="basic-addon1" value="<?=$title?>" >
                        </div>
...
//            $('#form1').submit();
//            return;
            var url=g_siteUrl+'question/modifyajax/<?=$spid?>/<?=$question_id?>';
            $.ajax({
                url: url,
