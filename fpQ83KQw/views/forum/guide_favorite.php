...
<!--top-->
<div class="wp">
    <?php $this->load->view('user_info_v1',array('user_currentTab'=>2));?>
    <div class="member_gl">
        <div class="member_gl_l l">
            <div class="tab">
                <?php if($isself){ ?>
                    <a class='my_class' href="<?php echo site_url('forum/guide')?>">发表的技术</a>
                    <a class='my_class acitvity_on' href="<?php echo site_url('forum/guide_favorite')?>">收藏的技术</a>
                <?php }else{?>
                    <a class='my_class' href="<?php echo site_url('forum/guide/'.$member['uid'])?>">发表的技术</a>
                    <a class='my_class acitvity_on' href="<?php echo site_url('forum/guide_favorite/'.$member['uid'])?>">收藏的技术</a>
                <?php }?>
                <div class="clear"></div>
            </div>
            <?php if($list){
