...
<div class="wp">
    ...
    <div class="member_gl">
        <div class="member_gl_l l">
            <div class="tab">
                <?php if($isself){ ?>
                    <a class='my_class acitvity_on' href="<?php echo site_url('forum/post')?>">发表的帖子</a>
                    <a class='my_class ' href="<?php echo site_url('forum/post_favorite')?>">收藏的帖子</a>
                <?php }else{?>
                    <a class='my_class acitvity_on' href="<?php echo site_url('forum/post/'.$member['uid'])?>">发表的帖子</a>
                    <a class='my_class ' href="<?php echo site_url('forum/post_favorite/'.$member['uid'])?>">收藏的帖子</a>
                <?php }?>
                <div class="clear"></div>
            </div>
            <?php if($list){
