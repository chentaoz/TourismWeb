...
<div class="wp">
    ...
    <div class="member_gl">
        <div class="member_gl_l l">
            <div class="tab">
                <?php if($isself){ ?>
                    <a class='my_class' href="<?php echo site_url('forum/travel')?>">发表的游记</a>
                    <a class='my_class acitvity_on' href="<?php echo site_url('forum/travel_favorite')?>">收藏的游记</a>
                <?php }else{?>
                    <a class='my_class' href="<?php echo site_url('forum/travel/'.$member['uid'])?>">发表的游记</a>
                    <a class='my_class acitvity_on' href="<?php echo site_url('forum/travel_favorite/'.$member['uid'])?>">收藏的游记</a>
                <?php }?>
                <div class="clear"></div>
            </div>
            <?php if($list){
