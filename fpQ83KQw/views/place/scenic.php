...
<div class="desti_menu_wp">
    <?php  if($top=='country'){?>
        <?php  $this->load->view('place/top1',array('currentTab' => 12));?>
    <?php }else{?>
        <?php  $this->load->view('place/top2',array('currentTab' => 12));?>
    <?php }?>
</div>
<div class="bg_f5">
    <div class="wp">
        ...
        <div class="r desti_right">
            ...
            <div class="desti_right_title">
                <?php if ($place_scenic) {
                    foreach ($place_scenic as $k => $v) {
                        ?>
                        <div class="desti_right_imgbox <?php if ($k%3 == 2) {
                            echo "mar12";
                        } ?> l">
                            <div class="desti_right_imgbox_img">
                                <a  href="<?= base_url('place/index/pid/' . $v['pid']) ?>"><img src="<?php echo get_img_url($v['img'],'268x182',2)?>"></a>
                            </div>
