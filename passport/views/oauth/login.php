        ...
        <div class="lg_table">
            ...
            <form action="" method="post" accept-charset="utf-8" id="form1" class="form_login">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" placeholder="用户名/Email" name="username" maxlength="40" aria-describedby="basic-addon1">
                </div>
                <!--key-->
                <div class="input-group">
					    <span class="input-group-addon" id="basic-addon1">
                ...
                <div class="btn-group submit-group" role="group" aria-label="...">
                    <input type="submit" value="登录" class="btn btn-defaults btn_submit">
                </div>
                <div class="lg_tips">
